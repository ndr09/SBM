...
def cart_pole_SNN_ratecode():
    ...
    for tests in range(5): # esegue 5 test ed effettua il grafico con medie e error bars
        ...
        save_scores(average_scores_history, best_scores_history, tests, "cart_pole_SNN_ratecode_")

        with open("./nn_cartpole_SNN_ratecode"+str(best_fitness)+".pkl", "wb") as f:
            pickle.dump(best_guy, f)

    plot_average_fitnesses(['cart_pole_SNN_ratecode_scores_run_0.txt', 'cart_pole_SNN_ratecode_scores_run_1.txt', 'cart_pole_SNN_ratecode_scores_run_2.txt', 'cart_pole_SNN_ratecode_scores_run_3.txt', 'cart_pole_SNN_ratecode_scores_run_4.txt'], "CartPole_SNN_ratecode.png")
