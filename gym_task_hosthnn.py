...
from my_network import HostHNN
import pickle
import sys
import os
import math
...
def eval(ds, render=False):
    ...
    agent = HostHNN([8, hnodes, 4], [2, 1, 1], 0.01)

    # set the hrules as the value of the candidates generated by cmaes
    agent.set_guests_hrules(x) 
...
def experiment_launcher(config):
    ...
    args = {}
    fka = HostHNN([8, hnodes, 4], [2, 2 ,1], 0.01)
    ...
    args["num_vars"] = fka.nweights * fka.guestnWeights * 4# Number of dimensions of the search space
