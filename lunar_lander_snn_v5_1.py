...
def plot_fitnesses(average_scores_history, best_scores_history):
    ...
    plt.savefig(f'./LunarLander_SNN_NoCode_PruningIteration#{len(average_scores_history)-1}.png')
...
if __name__ == "__main__":
    ...
    with open("./nn_lunarlander_SNN_nocode"+str(best_fitness)+".pkl", "wb") as f:
