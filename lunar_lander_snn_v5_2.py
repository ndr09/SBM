...
def rate_code(inputs, n_timesteps):
    ...
    scaled_inputs.append(math.tanh(double_inputs[8]))
    scaled_inputs.append(math.tanh(double_inputs[9]))
    scaled_inputs.append(math.tanh(double_inputs[10]))
    scaled_inputs.append(math.tanh(double_inputs[11]))
    scaled_inputs.append(math.tanh(double_inputs[12]))
    scaled_inputs.append(math.tanh(double_inputs[13]))
    scaled_inputs.append(math.tanh(double_inputs[14]))
    scaled_inputs.append(math.tanh(double_inputs[15]))
